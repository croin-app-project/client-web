    ...
    <Layout>
      ...
      >
        <div className="float-left" style={{ left: '5%', position: 'absolute' }}>
          <strong className='text-xl'>CROIN</strong>
        </div>
        {user ? (
          <>
            <div style={{ margin: '0px 10px' }}>
              <Tooltip title={user.username} placement="top">
                <Avatar size={'large'} style={{ backgroundColor: 'blue', margin: '0px 10px' }}>
        ...
        ) : <Button className="float-right" onClick={handleLogout}>Login</Button>}
      </Header>
